    ...
    for (const propertyName in value) {
        ...
        switch (propertyName) {
            ...
            case "$ref":
                ...
                break;
            case "$comment":
                if (!isSchemaComment(propertyValue)) {
                    return false;
                }
                break;
            case "title":
            ...
            case "readOnly":
                ...
                break;
            case "writeOnly":
                if (!isSchemaWriteOnly(propertyValue)) {
                    return false;
                }
                break;
            case "examples":
            ...
            case "contentMediaType":
                if (!isSchemaContentMediaType(propertyValue)) {
                    return false;
                }
                break;
            case "contentEncoding":
                if (!isSchemaContentEncoding(propertyValue)) {
                    return false;
                }
                break;
            case "if":
                if (!isSchemaIf(propertyValue)) {
                    return false;
                }
                break;
            case "then":
                if (!isSchemaThen(propertyValue)) {
                    return false;
                }
                break;
            case "else":
                if (!isSchemaElse(propertyValue)) {
                    return false;
                }
                break;
            case "allOf":
...
export function isSchemaComment(value: unknown): value is types.SchemaComment {
    if (!(isStringSchemaComment(value))) {
        return false;
    }
    return true;
}
function isStringSchemaComment(value: unknown): value is unknown {
    if (typeof value !== "string") {
        return false;
    }
    return true;
...
export function isSchemaDefault(value: unknown): value is types.SchemaDefault {
    if (!(isAnySchemaDefault(value))) {
        return false;
    }
    return true;
}
function isAnySchemaDefault(value: unknown): value is unknown {
    return true;
}
export function isSchemaReadOnly(value: unknown): value is types.SchemaReadOnly {
    if (!(isBooleanSchemaReadOnly(value))) {
        return false;
    }
    return true;
}
function isBooleanSchemaReadOnly(value: unknown): value is unknown {
    if (typeof value !== "boolean") {
        return false;
    }
    return true;
}
export function isSchemaWriteOnly(value: unknown): value is types.SchemaWriteOnly {
    if (!(isBooleanSchemaWriteOnly(value))) {
        return false;
    }
    return true;
}
function isBooleanSchemaWriteOnly(value: unknown): value is unknown {
    if (typeof value !== "boolean") {
        return false;
    }
    return true;
...
export function isSchemaConst(value: unknown): value is types.SchemaConst {
    if (!(isAnySchemaConst(value))) {
        return false;
    }
    return true;
}
function isAnySchemaConst(value: unknown): value is unknown {
    return true;
}
...
function isArraySchemaEnum(value: unknown): value is unknown {
    ...
    const elementValueSeen = new Set<types.SchemaEnumItems>();
    for (const elementIndex in value) {
        const elementValue = value[elementIndex];
        if (elementValueSeen.has(elementValue)) {
            return false;
...
export function isSchemaContentMediaType(value: unknown): value is types.SchemaContentMediaType {
    if (!(isStringSchemaContentMediaType(value))) {
        return false;
    }
    return true;
}
function isStringSchemaContentMediaType(value: unknown): value is unknown {
    if (typeof value !== "string") {
        return false;
    }
    return true;
}
export function isSchemaContentEncoding(value: unknown): value is types.SchemaContentEncoding {
    if (!(isStringSchemaContentEncoding(value))) {
        return false;
    }
    return true;
}
function isStringSchemaContentEncoding(value: unknown): value is unknown {
    if (typeof value !== "string") {
        return false;
    }
    return true;
}
export function isSchemaIf(value: unknown): value is types.SchemaIf {
    if (!isSchema(value)) {
        return false;
    }
    return true;
}
export function isSchemaThen(value: unknown): value is types.SchemaThen {
    if (!isSchema(value)) {
        return false;
    }
    return true;
}
export function isSchemaElse(value: unknown): value is types.SchemaElse {
    if (!isSchema(value)) {
        return false;
    }
    return true;
...
export function isSchemaExamplesItems(value: unknown): value is types.SchemaExamplesItems {
    if (!(isAnySchemaExamplesItems(value))) {
        return false;
    }
    return true;
}
function isAnySchemaExamplesItems(value: unknown): value is unknown {
    return true;
}
...
export function isSchemaEnumItems(value: unknown): value is types.SchemaEnumItems {
    if (!(isAnySchemaEnumItems(value))) {
        return false;
    }
    return true;
}
function isAnySchemaEnumItems(value: unknown): value is unknown {
    return true;
}
